...
begin
     ...
     begin
          ShowMessage('Não é possível excluir esse cidade porque há CLIENTES relacionado !');
          exit;
     end;
     ...
     if dm.Q_Geral.FieldByName('total').AsInteger > 0 then
     begin
          ShowMessage('Não é possível excluir esse cidade porque há FORNECEDOR relacionado !');
          exit;
     end;
