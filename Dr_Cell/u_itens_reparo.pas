...
begin
     ...
     pesq.Close;
     if MessageDlg('Deseja realmente excluir a Peça ' +
...
begin
     ...
     begin
          MessageDlg('O ´Cód da Peça deve ser Informado !',mtWarning,[mbOk],0);
          edit_cod_peca.SetFocus;
          exit;
     end;
     ...
     begin
          MessageDlg('O Cód da Peça deve ser valido !',mtWarning,[mbOk],0);
          edit_cod_peca.SetFocus;
          exit;
     end;
